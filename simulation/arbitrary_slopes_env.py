...
class SpotEnv(gym.Env):
    ...
    def hard_reset(self):
        ...
        wedge_model_path = "simulation/Track/"
    ...
    def get_foot_contacts(self):
        ...
        for leg in range(4):
            contact_points_with_ground = self._pybullet_client.getContactPoints(self.plane,
                                                                                self.spot,
                                                                                -1,
                                                                                foot_ids[leg])
            ...
            for wedge in self.wedge:
                contact_points_with_wedge = self._pybullet_client.getContactPoints(wedge,
                                                                                   self.spot,
                                                                                   -1,
                                                                                   foot_ids[leg])
