    ...
    def hard_reset(self):
        ...
        if self._is_wedge:
            ...
            if not self.downhill:
                wedge_model_path = "/home/quyetnguyen/PycharmProjects/SOLO12/simulation/Wedges/uphill/urdf/wedge_" + str(
        ...
        model_path = '/home/quyetnguyen/PycharmProjects/SOLO12/simulation/solo12/solo12.urdf'
