...
def load_simulation():
    ...
    wedgeOrientation = p.getQuaternionFromEuler([0, 0, incline_ori])  # Hướng của miếng cản

    # Đường dẫn mô hình URDF của miếng cản
    wedge_model_path = "simulation/Wedges/uphill/urdf/wedge_" + str(incline_deg) + ".urdf"
    ...
    p.changeDynamics(wedge_id, -1, lateralFriction=0.7)
