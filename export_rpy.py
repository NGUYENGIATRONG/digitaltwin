...
if __name__ == '__main__':
    ...
    plt.subplot(3, 1, 2)
    plt.plot(pitch_angles, label='Pitch Angle', color='orange')
    plt.ylabel('Pitch (degrees)')
    plt.legend()

    plt.subplot(3, 1, 3)
    plt.plot(yaw_angles, label='Yaw Angle', color='green')
